...
class MoneyTransferView(FormView):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            messages.error(self.request, f"Receiver's account with ID {receiver_account_id} not found.")
            return self.form_invalid(form)

        amount = form.cleaned_data['amount']
        if sender_account.balance < amount:
            messages.error(self.request, "Insufficient balance to perform the transfer.")
            return self.form_invalid(form)
        ...
        sender_transaction = Transaction.objects.create(
            ...
            transaction_type=Transaction.TYPE_SEND,
        ...
        messages.success(self.request, f"Money transferred successfully to {receiver_account.user.username}.")
